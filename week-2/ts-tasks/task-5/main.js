...
function LogInstance(constructor) {
    return /** @class */ (function (_super) {
        ...
        function class_1() {
            ...
            // Use type assertion to access `.name` safely
...
var Product = function () {
    var _classDecorators = [LogInstance];
    ...
    var Product = _classThis = /** @class */ (function () {
        ...
        Product_1.prototype.print = function () {
...
var pen = new Product("Pen", 2.5);
pen.print();
var notebook = new Product("Notebook", 5.99);
notebook.print();
