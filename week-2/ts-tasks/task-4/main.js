...
function isStringArray(x) {
    ...
    return Array.isArray(x) && x.every(function (item) { return typeof item === "string"; });
}
// Test data
var test1 = ["a", "b", "c"]; // Should pass
var test2 = [1, 2, "c"]; // Should fail
// Check first data
if (isStringArray(test1)) {
    console.log("test1 is a string array");
    console.log(test1.map(function (str) { return str.toUpperCase(); })); // Use safely
}
else {
